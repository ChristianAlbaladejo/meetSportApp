...
/* harmony import */ var _services_follow_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/follow.service */ "./src/app/services/follow.service.ts");
/* harmony import */ var _services_publication_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/publication.service */ "./src/app/services/publication.service.ts");
...
/* harmony import */ var _publication_publication_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../publication/publication.page */ "./src/app/publication/publication.page.ts");
/* harmony import */ var _profile_profile_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../profile/profile.page */ "./src/app/profile/profile.page.ts");
...
let HomePage = class HomePage {
    constructor(menuCtrl, modalController, _publicationService, _route, _router, _userService, alert, loading, navCtrl, _followService, _googleMaps) {
    ...
    delete(p) {
        this._publicationService.deletePublication(this.token, p).subscribe(response => {
            if (response.publications) {
            }
            else {
            }
    ...
    like(publication) {
        this.identity = this._userService.getIdentity();
        this._publicationService.like(this.token, publication).subscribe((response) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!response) {
                const alert = yield this.alert.create({
                    message: 'Ohh! Something gone wrong. 😥',
                    buttons: ['OK']
    ...
    dislike(publication) {
        this.identity = this._userService.getIdentity();
        this._publicationService.dislike(this.token, publication).subscribe((response) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!response) {
                const alert = yield this.alert.create({
                    message: 'Ohh! Something gone wrong. 😥',
                    buttons: ['OK']
